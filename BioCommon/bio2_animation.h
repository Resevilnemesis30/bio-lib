...
class Resident_Evil_2_Animation :
...
public:
	...
	/*
		Construction
	*/
	explicit Resident_Evil_2_Animation(void)
	{
		SetGame(Resident_Evil_Video_Game::Resident_Evil_2);
	}
	virtual ~Resident_Evil_2_Animation(void)
	{
	}
	...
	*/
	std::unique_ptr<Resident_Evil_Animation> ExportBio1(void);
